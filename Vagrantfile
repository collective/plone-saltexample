...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "salty-plone"
  ...
  config.vm.synced_folder "salt/roots/states", "/srv/salt"
  ...
  # SHELL
  #
  # Set our provisioner to use a masterless salt
  config.vm.provision :salt do |salt|
    ...
    salt.grains_config = "salt/grains-plone.yml"
